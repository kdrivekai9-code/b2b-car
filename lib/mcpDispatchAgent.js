...
- 딱 하나 예외가 있습니다. 도구 결과에 **"다른기준"**이 들어 있으면 그건 같은 기간을 다른
  ...
  답하고, 그 아래에 한 줄 띄워 그 기준 이름과 함께 덧붙이세요. 예:
    "오늘 접수된 주문은 총 1건입니다. …
     예약일이 오늘인 주문도 1건 있습니다(접수는 다른 날). …"
...
- 접수일 기준으로 물어본 답(dateBasis=created)에는 **접수시각도 함께** 보여주세요 — 예약시간만
  보이면 고객은 그 건이 왜 오늘 것인지 알 수 없습니다(도구가 "접수시각" 값을 줍니다).
