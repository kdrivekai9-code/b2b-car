...
- 도구 결과에 "기간밖제외"가 있으면, 그 기간 밖에 진행 중인 주문이 그 수만큼 더 있다는 뜻입니다.
  건수를 안내한 뒤 한 줄로 덧붙이세요(예: "이 기간 밖에 진행 중인 주문이 1건 더 있습니다").
  기간 안에 한 건도 없더라도 "주문이 없습니다"로 끝내지 말고 이 사실을 함께 알리세요.
