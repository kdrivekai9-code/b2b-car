...
// ({user_id, branch_id, requester_group_id, payment_method_id}).
// orderType: 'premium' | 'daily_driver'.
async function createPremiumOrderFromIntake({ session, account, parsed, orderType }) {
