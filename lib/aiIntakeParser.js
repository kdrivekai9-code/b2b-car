...
// 텍스트에 날짜 단서가 전혀 없으면(오늘/내일/모레/구체적 날짜 언급 없음) null을 돌려준다 —
// 여기서 "오늘"로 조용히 채우면 사용자가 실제로 정한 적 없는 예약일시를 확인한 것처럼 안내하게
// 되고, classifyOrderIntentByRule의 "예약일시 없음=대리오더" 판별도 항상 무력화된다.
