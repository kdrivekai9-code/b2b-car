...
//
// 범위: 탁송(dispatch_order)의 수집→확인 루프만. 프리미엄/일일기사, choose_field(필드 직접
// 지정 수정), offer_agent(상담원 제안)는 이번 범위 밖 — 지금처럼 브라우저가 처리한다.
//
...
// 안내한다(카카오의 handleAddressChoiceReply와 같은 역할).
