  ...
  try {
    return await exec.run(`
      INSERT INTO orders (oid, branch_id, requester_group_id, origin_address, origin_address_detail, origin_contact,
        ...
        status, memo_customer, memo_billing, memo_driver_brief, created_by, chat_session_id, source_channel,
        split_group_id, split_seq, split_total)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '오더등록', ?, ?, ?, ?, ?, ?, ?, ?, ?)
      RETURNING id
    `, [
      ...
      o.memoCustomer, o.memoBilling, o.memoDriverBrief, o.createdBy, o.chatSessionId, o.sourceChannel,
