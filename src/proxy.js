...
export function proxy(req) {
  ...
  const idSuffixRoutes = [
    ...
    { re: /^\/branches\/(\d+)\/(edit|payment-methods|operating-hours|order-status|photo-settings|extra-settings|callmaner|premium-fare-rules|premium-oneway-fare-rules|dispatch-fare-rules)$/, flag: 'NEXT_BRANCH_SETTINGS_ENABLED' },
  ];
