...
export function proxy(req) {
  ...
  const idSuffixRoutes = [
    ...
    { re: /^\/branches\/(\d+)\/(payment-methods|order-status|photo-settings|extra-settings|callmaner)$/, flag: 'NEXT_BRANCH_SETTINGS_ENABLED' },
  ];
