...
export function proxy(req) {
  ...
  const idSuffixRoutes = [
    ...
    { re: /^\/groups\/(\d+)\/(accounts|fare-rules|office-fares|daily-driver-fare-rules|premium-fare-rules|customer-notifications|dispatch-delay)$/, flag: 'NEXT_GROUP_SETTINGS_ENABLED' },
