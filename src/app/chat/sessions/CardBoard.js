...
// 담당자명이 이미 거래처명으로 시작하면(예: "서울모터스 채정식") 회사명이 괄호 앞에서 이미
// 나오므로, 괄호 안에서는 그 접두어를 떼어 담당자명만 남긴다.
