...
const photoDeliveryRoutes = require('./routes/photoDelivery');
...
// 법인 계정용 「사진 전송리스트」 — 탁송사진·실비영수증을 오더별로 모아 보고 한 번에 내려받는다.
// 지금까지 고객이 사진에 닿는 길은 카카오로 받은 링크 한 건씩(/photos/:token)뿐이라, 지난
// 오더를 다시 보려면 상담원이 링크를 새로 만들어 보내야 했다.
app.use('/my/photos', photoDeliveryRoutes);
